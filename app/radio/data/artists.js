...
export const ARTISTS = [
  ...
  },
  {
    ...
    tour: [
      { date: 'Sep 19', city: 'Rudford, Gloucestershire', venue: 'Days in the Sun Music & Arts Festival' },
      ...
      { date: 'Dec 10', city: 'Perth, Scotland',          venue: 'Perth Theatre and Concert Hall' },
      { date: 'Dec 11', city: 'Oban, Scotland',           venue: 'The Corran Halls' },
    ],
    isPartner: false,
  },
  {
...
export const FALLBACK = {
  ...
  // rèidio icon (radio tower from the Cuairt-shruth swirl, transparent bg) is
