  ...
  const apps = [
    {
      ...
      gd: 'Abair De?',
      en: 'Abair De?',
      desc_en: 'Immersive Gàidhlig through real-world scenes with Ceitidh and Aileen',
      desc_gd: 'Gàidhlig bogadh tro shuidheachaidhean beatha làitheil le Ceitidh agus Aileen',
      available: true,
    },
    {
      id: 'de-sin-de-seo',
      ...
      <section className="relative text-white py-16">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-semibold mb-4 tracking-wide" style={{textShadow: '0 2px 8px rgba(0,0,0,0.9)'}}>
            {language === 'gd' ? 'Ionnsaich Gàidhlig' : 'Learn Gàidhlig'}
          </h1>
              ...
              app.available ? (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-tarheel text-2xl group-hover:translate-x-1 transition-transform ml-4">→</span>
                  </div>
                </Link>
              ) : (
                <div
